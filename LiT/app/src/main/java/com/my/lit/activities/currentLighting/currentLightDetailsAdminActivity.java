...
public class currentLightDetailsAdminActivity extends AppCompatActivity {
    ...
    private void searchSetUp() {
        currentLightDetailsAdminBinding.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
    ...
    private void setData() {
        ...
        currentLightDetailsAdminBinding.lightDetailsRv.setAdapter(adapter);
    }
}